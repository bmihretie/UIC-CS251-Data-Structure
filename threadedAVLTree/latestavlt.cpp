...
//
  ...
  void _RightRotate(NODE* Parent, NODE* N)
  {
    ...
    NODE* B = L->Right;
	NODE* C = N->Right;
	//cout << " before rotataion L: " << L->Key << endl;
	//cout << " before rotataion A: " << A->Key << endl;
	//cout << " before rotataion B: " << B->Key << endl;
	//cout << " before rotataion C: " << C->Key << endl;
	 ...
	 L->isThreaded = false;
	 //N->Left = B;
    //cout << " After  rotation L->Right: " << L->Right->Key << endl;
	//cout << " After  rotation L->Left: " <<  L->Left->Key << endl;
	//cout << " After  rotation N->Right:" << N->Right->Key << endl;
	//cout << " After  rotation N->Left: " << N->Left->Key << endl;
